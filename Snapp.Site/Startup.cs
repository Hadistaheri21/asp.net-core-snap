...
namespace Snapp.Site
{
    public class Startup
    {
        ...
        public string CookiAuthenticationDefaults { get; private set; }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SnappDbContext>(options =>
           {
               options.UseSqlServer(Configuration.GetConnectionString("Defultconnections"));
           });
